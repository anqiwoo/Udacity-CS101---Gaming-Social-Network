...
def create_data_structure(string_input):
    ...
    if len(string_input) != 0:
        ...
        # for empty input, the for loop will not be executed.
...
def count_common_connections(network, user_A, user_B):
    ...
    return common_connections(user_A_connections, user_B_connections)
